"""Dependency providers wiring Infrastructure implementations to Core interfaces.

This module offers constructor-injection factory functions and a lightweight
`DIContainer` to assemble dependencies for application bootstrapping. No
business logic is implemented here — only wiring.
"""
