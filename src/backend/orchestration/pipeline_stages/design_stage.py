...
class DesignStage:
    """Orchestration-only stage that coordinates architecture/technology/infrastructure agents.

    Constructor-injected scheduler and pipeline manager. Async execute.
    """
